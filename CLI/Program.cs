...
namespace MCNebula.Cli {
    public static class Program {
        ...
        public static void Main(string[] args) {
            ...
            // If MCNebula_.dll is missing, a FileNotFoundException will get thrown for MCNebula dll
            try
            {
                EnableCLIMode();
            } catch (FileNotFoundException) {
                Console.WriteLine("Cannot start server as MCNebula_.dll is missing from " + Environment.CurrentDirectory);
            ...
            // separate method, in case MCNebula_.dll is missing
            StartCLI();
        }
        ...
        static void EnableCLIMode() {
            try {
                ...
                // in case user is running CLI with older MCNebula dll which lacked CLIMode field
            }
        ...
        static void StartCLI() {
            ...
            try {
                ...
                EnableCLIMode();
                Server.Start();
                Console.Title = Colors.Strip(Server.Config.Name) + " - " + Colors.Strip(Server.SoftwareNameVersionedAlpha);
        ...
        static void LogNewerVersionDetected(object sender, EventArgs e) {
            Write("&cMCNebula update available! Update by replacing with the files from " + Updater.UploadsURL);
        }
