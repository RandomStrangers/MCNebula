...
namespace MCNebula.Gui 
{
    public partial class Window : Form 
    {
        ...
        static void CheckVersions() {
            string gui_version = Server.InternalVersionAlpha;
            string dll_version = Server.VersionAlpha;
...
Trying to mix two versions is unsupported - you may experience issues";
            string msg = string.Format(fmt, Server.SoftwareName, 
                                       gui_version, AssemblyFile(typeof(Window), "MCNebula.exe"),
                                       dll_version, AssemblyFile(typeof(Server), "MCNebula_.dll"));
        ...
        void Window_Load(object sender, EventArgs e) {
            ...
            Text = "Starting " + Colors.Strip(Server.SoftwareNameVersionedAlpha) + "...";
            Show();
            BringToFront();
            ...
            Text = Colors.Strip(Server.Config.Name) + " - " + Colors.Strip(Server.SoftwareNameVersionedAlpha);
            MakeNotifyIcon();
