...
using MCNebula.Events.EntityEvents;
using MCNebula.Events.PlayerEvents;
using MCNebula.Events.PlayerDBEvents;
...
namespace MCNebula {
    public sealed class ConsolePlayer : Player {//didn't have public modifier
    ...
    public partial class Player : Entity, IDisposable {
        ...
        public string MakeTitle(string title, string titleCol) {//was internal
        ...
        public byte UserType() { return group.CanPlace[Block.Bedrock] ? (byte)100 : (byte)0; }//was internal
