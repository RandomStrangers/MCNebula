...
namespace MCNebula 
{
    public sealed partial class Server 
    {
        ...
        public static string SoftwareName = "MCNebula";
        static string fullName;
        static string fullNameAlpha;
        ...
        public const long MAX_PLAYERS = long.MaxValue;
        
        public static Scheduler MainScheduler = new Scheduler("MCN_MainScheduler");
        public static Scheduler Background = new Scheduler("MCN_BackgroundScheduler");
        public static Scheduler Critical = new Scheduler("MCN_CriticalScheduler");
        public static Scheduler Heartbeats = new Scheduler("MCN_HeartbeatsScheduler");
