...
using MCNebula.Modules.Relay.IRC;

namespace MCNebula 
{
    public sealed class ServerConfig : EnvConfig 
    {
        [ConfigString("server-name", "Server", "[MCNebula] Default", false, " !\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~")]
        public string Name = "[MCNebula] Default";
        [ConfigString("motd", "Server", "Welcome", false)]
        public string MOTD = "Welcome!";
        [ConfigLong("max-players", "Server", 16, 1, Server.MAX_PLAYERS)]
        public long MaxPlayers = 16;
        [ConfigLong("max-guests", "Server", 14, 1, Server.MAX_PLAYERS)]
        public long MaxGuests = 14;
...
#if DEV
        [ConfigString("HeartbeatURL2", "Other", "https://www.classicube.net/heartbeat.jsp", false, ":/.,")]
        public string HeartbeatURL2 = "https://www.classicube.net/heartbeat.jsp";
#endif
        ...
        [ConfigString("irc-nick", "IRC bot", "NebulaBot")]
        public string IRCNick = "NebulaBot";
