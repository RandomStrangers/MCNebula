...
namespace MCNebula.DB 
{
    ...
    {     
        ...
        public static string[] CompactMessages = new string[] {
            ...
            "   a) doing VACUUM on the database (note that this will create a temp file as big as MCNebula.db)",
            "   b) doing /server backup litedb, shutting down the server, deleting MCNebula.db, then finally running /server import SQL",
        };
