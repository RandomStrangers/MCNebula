...
namespace MCNebula.Network
{
    ...
    public sealed class ClassiCubeBeat : Heartbeat
    {
        ...
        public override string GetHeartbeatData()  {//was protected
            ...
            return
                ...
                "&software=" + Uri.EscapeDataString(Server.SoftwareNameVersionedAlpha) +
                "&web="      + Server.Config.WebClient;
        }
        
        public override void OnRequest(HttpWebRequest request) {//was protected
        ...
        public override void OnResponse(WebResponse response) {//was protected
        ...
        public override void OnFailure(string response) {//was protected
