...
namespace MCNebula 
{
    ...
    public abstract class Plugin 
    {
        ...
        /// <summary> The oldest version of MCNebula this plugin is compatible with. </summary>
        public virtual string MCNebula_Version { get; }
        ...
        public static void Load(Plugin pl, bool auto) {
            //string ver = pl.MCNebula_Version;
            //if (!String.IsNullOrEmpty(ver) && new Version(ver) > new Version(Server.VersionAlpha)) {
